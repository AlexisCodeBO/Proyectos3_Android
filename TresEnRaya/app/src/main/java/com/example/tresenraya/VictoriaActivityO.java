...
public class VictoriaActivityO extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_victoria_o);
    ...
    View.OnClickListener volverM=new View.OnClickListener() {
        ...
        public void onClick(View view) {
            Intent intento=new Intent(VictoriaActivityO.this,MainActivity.class);
